...
const SocialLogin = () => {
   ...
   const[errorMessage,setErrorMessage]=useState('')
    ...
    const {SignInUser,signInWithGoogle,loading,user}=use(AuthContext) 
   
    const handleGoogleSignIn = async () => {
  try {
    await signInWithGoogle(); // popup sign-in
  ...
  if (!loading && user) {
    ...
    return (
        <div>
            ...
            <div className='mt-6'>
                {/* Github */}
                <button className="btn mb-3 bg-black text-white border-black w-full">
